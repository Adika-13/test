...
<section class="content-header">
    <h1>
        ...
        <a class="btn btn-primary btn-social pull-right" href="?module=form_obat&form=add" title="Tambah Data"
            data-toggle="tooltip">
...
<section class="content">
    ...
    ?>
            ...
            $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,harga_jual,satuan,stok FROM is_obat ORDER BY kode_obat DESC")
