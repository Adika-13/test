 ...
 <section class="content-header">
     <h1>
         ...
         <a class="btn btn-primary btn-social pull-right" href="?module=form_user&form=add" title="Tambah Data"
             data-toggle="tooltip">
    ...
    ?>
            ...
            // menampilkan isi tabel dari database ke tabel di aplikasi
              echo "<tr>
                      ...
                      if ($data['foto']=="") { ?>
                             <td class='center'><img class='img-user' src='images/user/user-default.png' width='45'>
                             </td>
                             <?php
                      } else { ?>
                             <td class='center'><img class='img-user' src='images/user/<?php echo $data['foto']; ?>'
                                     width='45'></td>
                             <?php
                      }
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td class='center' width='100'>
                          ...
                          if ($data['status']=='aktif') { ?>
                             <a data-toggle="tooltip" data-placement="top" title="Blokir" style="margin-right:5px"
                             ...
                             <a data-toggle="tooltip" data-placement="top" title="Aktifkan" style="margin-right:5px"
